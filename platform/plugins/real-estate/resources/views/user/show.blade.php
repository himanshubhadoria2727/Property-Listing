<div class="container" style="max-width: 1280px; padding: 24px; margin: auto; overflow-y: auto;">
    ...
    <div style="display: flex; flex-direction: column; gap: 16px;">
        ...
        @php $property = $booking->property; @endphp
        <div class="booking-strip dark:bg-gray-800"
            ...
            <div style="flex-grow: 1; display: flex; flex-direction: column; gap: 8px;">
                <span class="dark:text-white" style="font-size: 1.1rem; font-weight: bold; color: #1f2937;">{{ \Carbon\Carbon::parse($booking->scheduled_at)->format('Y-m-d H:i') }}</span>
                <span class="dark:text-white" style="font-size: 1rem; color: #374151;">{{ $property->name }}</span>
                <span class="dark:text-white" style="font-size: 1rem; color: #374151;">{{ $property->location }}</span>
                <!-- <span style="font-size: 0.9rem; color: #6b7280; width:80%;">{{ $property->description }}</span> -->
            </div>
